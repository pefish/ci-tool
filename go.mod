...
require (
	github.com/pefish/go-best-type v0.0.9
	github.com/pefish/go-commander v0.6.2
	github.com/pefish/go-config v0.4.0
	github.com/pefish/go-core v1.4.4
	github.com/pefish/go-core-type v0.1.3
	github.com/pefish/go-error v1.0.8
	github.com/pefish/go-file v0.2.3
	github.com/pefish/go-http v0.6.7
...
require (
	...
	github.com/pefish/go-format v0.3.1 // indirect
